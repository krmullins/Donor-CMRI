 ...
 * @author Daniel L贸pez Aza帽a <daniloaz@gmail.com>
 * @version 1.0
 */
/**
...
define("TABLES", '*'); // Full or partial backup
...
if (php_sapi_name() != "cli") {
    echo "<br><div class='text-center'><h3>DATABASE BACKUP RESULTS</h3></div>";
...
if (php_sapi_name() != "cli") {
    echo "<div class='text-center'><a href='' class='btn btn-danger'><b>Exit</b></a></div>";
    echo '</div>';
}
