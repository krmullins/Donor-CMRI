...
if (MULTI_TENANTS)
    redirect(SaaS::passResetUrl(), true);
...
<head>
    ...
    <title>
        <?php echo $translate['Password Reset']; ?>
    </title>
    <!-- Favicon icon -->
    ...
    //get forgot_password options
    $forgot_password_card_color =(empty(get_option('forgot_password_card_color')))? 'primary': get_option('forgot_password_card_color');
    $forgot_password_card_outline = (get_option('forgot_password_card_outline') == 'yes') ? 'card-outline' : '';
    $forgot_password_background_image = get_option('forgot_password_background_image') ?? '';
    ?>
</head>

<body class="hold-transition login-page" <?php if (!empty($forgot_password_background_image)) {
    echo 'style="background-image: url(' . $forgot_password_background_image . ');background-size: cover"';
} ?>>
    <div class="login-box">
        <div class="card <?= $forgot_password_card_outline; ?> card-<?= $forgot_password_card_color; ?>">
            ...
            <div class="card-body">
                ...
                if (Request::val('key')) {
                    ...
                    if ($row = db_fetch_assoc($res)) {
                        ...
                        <div class="page-header">
                            <h1>
                                <?php echo $Translation['password change']; ?>
                            </h1>
                        </div>
                                ...
                                <form method="post" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" autocomplete="new-password" id="newPassword"
                                            name="newPassword"
                                            placeholder="<?php echo html_attr($Translation['new password']); ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" autocomplete="new-password"
                                            ...
                                            placeholder="<?php echo html_attr($Translation['confirm password']); ?>">
                                    </div>

                                    <div class="row">
                                        <div class="col-sm-offset-3 col-sm-6">
                                            <button class="btn btn-<?= $forgot_password_card_color; ?> btn-lg btn-block"
                                                value="changePassword" id="changePassword" type="submit" name="changePassword"
                                                value="1">
                                                <?php echo $Translation['ok']; ?>
                                            </button>
                                        </div>
                                    </div>
                ...
                if (Request::val('reset')) {
                    ...
                    <div class="page-header">
                        <h1>
                            <?php echo $Translation['password reset']; ?>
                        </h1>
                    </div>
                    <?php
                        ...
                        <div class="col-md-12 col-md-offset-3">
                            <div class="alert alert-info">
                                <i class="glyphicon glyphicon-info-sign"
                                    style="font-size: xx-large; float: left; margin: 0 10px;"></i>
                ...
                <p class="login-box-msg">
                    <?php echo $Translation['password reset details']; ?>
                </p>
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-<?= $forgot_password_card_color; ?> btn-block"
                                value="<?php echo html_attr($Translation['ok']); ?>" id="reset" type="submit"
                                name="reset">
                                <?php echo $translate['Request new password']; ?>
                            </button>
                        </div>
                        <!-- /.col -->
                    </div>
                    <?php if (is_array(getTableList()) && count(getTableList())) { /* if anon. users can see any tables ... */?>
                        <p style="margin-top: 1.5em;"><a href="index.php"><i
